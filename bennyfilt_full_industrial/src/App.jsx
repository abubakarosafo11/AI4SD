...
// Fixed pilot filter assumptions (kept internal for simplicity)
const MEDIA_MASS_G = 3000;   // 3 kg adsorbent/active media
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-6">
        ...
        <div className="mt-5 grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-4 shadow-xl backdrop-blur">
            ...
            <Field label="Turbidity (NTU)" value={turb} setValue={setTurb} step={1} min={0} max={1500} hint="Galamsey water can be 300–1000+ NTU" />
            <Field label="Water treated per day (L/day)" value={flow} setValue={setFlow} step={10} min={0} hint="Increasing L/day reduces predicted filter life (days)" />
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-4 shadow-xl backdrop-blur lg:col-span-2">
            ...
            <div className="mt-4 rounded-3xl border border-white/10 bg-white/5 p-3 text-xs text-white/70">
              Note: This is a decision-support estimator for exhibitions and early-stage design. Confirm with lab tests.
            </div>
          </div>
        </div>
      </div>
